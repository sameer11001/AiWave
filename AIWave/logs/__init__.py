...
class CustomLogger:
    ...
    def info(self, message: str) -> None:
        ...
        """
        CustomLogger.info_logger.info(f"{self.name} - {message}")
    ...
    def error(self, message: str, code: Optional[str] = None) -> None:
        ...
        """
        if code:
            CustomLogger.error_logger.error(f"{self.name} -  {code}: {message}")
        else:
            CustomLogger.error_logger.error(f"{self.name} - {message}")
    ...
    def debug(self, message: str) -> None:
        ...
        Args:
            message (str): The message to be logged.
        """
        CustomLogger.debug_logger.debug(f"{self.name} - {message}")
    ...
    def warning(self, message: str) -> None:
        ...
        Args:
            message (str): The message to be logged.
        """
        CustomLogger.warning_logger.warning(f"{self.name} - {message}")
