...
logger = CustomLogger('vision_wave_routes [classes]')


@vision_wave_blueprint.route('/classes', methods=['GET'])
def classes():
    """
    The classes vision_wave endpoint.
    """
    try:     
        ...
        return r.success(message="Classes are retrieved", data=classes_name)
